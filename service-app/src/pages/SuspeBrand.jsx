...
import suspeBrandImage1 from '../components/assets/bilstein.PNG';
import suspeBrandImage2 from '../components/assets/eibach.PNG';
    ...
    <div className="container mx-auto mt-30 p-4 md:max-w-lg lg:max-w-xl xl:max-w-2xl">
      ...
      <div className="space-y-10">
        <section className="text-center">
          <img src={suspeBrandImage1} alt="Anovia Titan Wheels" className="max-w-full h-auto rounded-lg mx-auto" />
        ...
        <section className="text-center">
          <img src={suspeBrandImage2} alt="Ferrada CM2 Wheels" className="max-w-full h-auto rounded-lg mx-auto" />
          <div className="product-details text-white mt-4">
